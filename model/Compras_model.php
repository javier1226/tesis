...
class Compras
{
    ...
    {
        $sql = "SELECT CONCAT(c.id,' | ',c.codigo) as codigo, fecha_compra, fecha_entrega, total, e.nombre as estado, p.nombre as proveedor, telefono, correo, direccion, p.avatar as avatar 
        FROM compra as c
