$(document).ready(function () {
        ...
        let datos = {
            ...
            datasets: [{
                ...
                },
                {
                    ...
                    pointRadius: false,
                    pointColor: '#3b8bba',
                    pointStrokerColor: 'rgba(0, 0, 255,1)',
                    pintHighlightFill: '#fff',
                    pintHighlightStroke: 'rgba(0, 0, 255,1)',
                    data: [lista[3].total]
                },
                {
                    ...
                    pointRadius: false,
                    pointColor: '#3b8bba',
                    pointStrokerColor: 'rgba(255, 255, 0,1)',
                    pintHighlightFill: '#fff',
                    pintHighlightStroke: 'rgba(255, 255, 0,1)',
                    data: [lista[4].total]
                }
            ]
        }
    ...
    async function ventas_anual() {
        ...
        funcion = 'venta_mes';
        let lista1 = ['', '', '', '', '', '', '', '', '', '', '', '']
        const response1 = await fetch('../controller/VentaController.php', { //para el manejo de la sincronia
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            },
        ...
        let datos = {
            ...
            datasets: [{
                ...
                },
                {
                    ...
                    pointRadius: false,
                    pointColor: '#c1c7d1',
                    pointStrokerColor: 'rgba(210, 214, 222,1)',
                    pintHighlightFill: '#fff',
                    pintHighlightStroke: 'rgba(210, 214, 222,1)',
